            ...
            >
                ...
                <Grid container spacing={4} justifyContent="space-between">
                    <Grid item xs={12} md={4}>
                        ...
                        <Typography variant="body2" sx={{ color: '#ffffffff', maxWidth: '300px', lineHeight: 1.6 }}>
                    ...
                    <Grid item xs={12} md={8}>
                        <Grid container spacing={4}>
                            <Grid item xs={6} sm={4}>
                                ...
                                <Stack spacing={1}>
                                    {['Features', 'Community', 'Help Center'].map((text) => (
                                        <Link key={text} component={RouterLink} to="#" sx={{ color: '#ffffffff', textDecoration: 'none', '&:hover': { color: 'red' } }}>
                                            {text}
                                        </Link>
                                    ))}
                                </Stack>
                ...
                <Box sx={{ mt: 6, pt: 3, borderTop: '1px solid rgba(0, 0, 0, 0.1)', display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: 'center', gap: 2 }}>
                    <Typography variant="body2" sx={{ color: '#6b7280' }}>
                        © {currentYear} Flux Inc. All rights reserved.
                    </Typography>
                    
                    <Stack direction="row" spacing={2}>
                        <IconButton size="small" component="a" href="https://www.linkedin.com/in/azhaanalisiddiqui/" target="_blank" sx={{ color: '#9ca3af', '&:hover': { color: '#DC143C' } }}>
                            <LinkedInIcon />
                        </IconButton>
                        <IconButton 
                            component="a" 
